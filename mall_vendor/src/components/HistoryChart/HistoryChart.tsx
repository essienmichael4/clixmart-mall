...
const HistoryChart = () => {
    ...
    const historyDataQuery = useQuery<[]>({
        ...
        queryFn: async() => await axios_instance_token.get(`/stats/vendor-history?timeframe=${timeframe}&month=${period.month}&year=${period.year}`).then(res => {
            return res.data
        })
    })
...
function CustomTooltip({active, payload}: any){
    ...
    const {orders, products, revenue} = data
