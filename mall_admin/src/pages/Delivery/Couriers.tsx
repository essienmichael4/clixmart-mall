...
import CouriersTable from "./_components/CouriersTable"
    ...
    <div className="container w-full mx-auto mt-2 px-4">
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-xs text-gray-400">This is the Couriers management page for all inter-city deliveries.</p>
        </div>
        {/* <AddHub trigger={
      ...
      <CouriersTable limit={limit} search={debouncedValue} page={page} setLimit={setLimit} setPage={setPage} />
    </div>
  )
}
