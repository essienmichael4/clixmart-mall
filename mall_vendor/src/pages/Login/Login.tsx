            ...
            <div className="bg-blue-700 py-8 w-full mb-8 flex justify-center items-start text-white md:hidden">
                <div className="px-4 w-full sm:w-3/4">
                    ...
                    <div className="md:hidden">
                        ...
                        <p className="text-white/70 text-xs">Welcome to CLIXMART MALL Vendor Panel - Let's help you sign in</p>
                    </div>
                </div>
            </div>
            <div className="flex justify-center items-start w-full lg:w-[50%]">
                <div className="px-4 w-full sm:w-3/4">
                    ...
                    <div className="hidden md:block">
                        ...
                        <p className="text-neutral-500 text-xs lg:text-sm">Welcome to CLIXMART MALL Vendor Panel - Let's help you sign in</p>
                    </div>
