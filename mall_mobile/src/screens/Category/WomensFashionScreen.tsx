...
type Props = NativeStackScreenProps<RootStackParamList, "WomensFashion">;

export default function WomensFashionScreen({ navigation }: Props) {
  const products = getProductsByCategory("Woman's Fashion");
