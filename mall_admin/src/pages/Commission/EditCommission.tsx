...
import { EditCommissionSchema, EditCommissionSchemaType } from '@/schema/commissions'
...
const EditCommission = ({trigger, commission}:Props) => {
  ...
  const addCommission = async (data:EditCommissionSchemaType)=>{
    const response = await axios_instance_token.patch(`/commissions/${commission.id}`, {
      ...data,
    },)
  ...
  const onSubmit = (data:EditCommissionSchemaType)=>{
    toast.loading("Editing commission...", {
      id: "add-commission"
    })
    mutate(data)
  }
              ...
              <FormField 
                ...
                render={({}) =>(
                    <FormItem className='flex flex-col'>
                        ...
                        <FormControl>
                          <span className='text-lg'>{commission.category.name}</span>
                        </FormControl>
                    </FormItem>
                )}
              />
